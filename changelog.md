...
All notable changes to VCP are documented here.
...
- Recorded the current repository purpose: VCP is the working repository for the Cologne digitization of Vachaspatyam.
