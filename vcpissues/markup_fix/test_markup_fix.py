"""Synthetic tests for 08_markup_fix.py (VCP)."""
...
print("=== no paired tags — trim no-op ===")
line, n = fix_trim_whitespace("plain text no tags")
check("no-tag no-op", line, "plain text no tags")
check("no-tag n", n, 0)
