"""hw_cmp5_chk1.py  Feb 8, 2014
 Checks hw_cmp5.txt for completeness of coverage of vcpte
...
def extract_recs(filein):
 ...
 for line in f:
  ...
  if mtype == "onlyfile#2":
   nskip = nskip + 1
   continue
  rec1arr = re.split(r'[;]',rec1)
  for r1 in rec1arr:
   (key,l1str,l2str) = re.split(r'[:,]',r1)
   l1 = int(l1str)
   l2 = int(l2str)
   if l1 < lmin:
    lmin = l1
